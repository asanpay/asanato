...
use App\Containers\Withdrawal\Exceptions\UnCancelableWithdrawException;
...
class DeleteWithdrawalAction extends Action
{
    public function run(Request $request)
    {
        ...
        throw new UnCancelableWithdrawException();
    }
