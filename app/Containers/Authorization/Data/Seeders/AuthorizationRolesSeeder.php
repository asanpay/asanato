...
/**
 * Class AuthorizationRolesSeeder
 */
class AuthorizationRolesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Apiato::call(
            ...
            ['finance-manager', 'Finance Manager', 'Finance Member Role', 799]
        );
        Apiato::call(
            'Authorization@CreateRoleTask',
            ['finance-operator', 'Finance Operator', 'Finance Operator Role', 700]
        );

        Apiato::call('Authorization@CreateRoleTask', ['support-manager', 'Support', 'Support Manager Role', 699]);
        Apiato::call(
            'Authorization@CreateRoleTask',
            ['support-operator', 'Support Operator', 'Support Operator Role', 600]
        );
